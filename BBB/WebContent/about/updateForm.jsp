...
<td>작성자</td> <br>
<td>
	<input type="text" name="name" value="<%=bb.getName()%>"  readonly="readonly">
</td>
</tr>
<tr>
<td>비밀번호</td>
...
<td>제목</td>
<td>
	<input type="text" name="subject" size=20 value="<%=bb.getSubject()%>">
</td>
</tr>
<tr>
<td>내용</td>
<td>
	<textarea rows="20" cols="60" name="content"><%=bb.getContent()%></textarea>
</td>
</tr>
</table>
<div id="table_search">
