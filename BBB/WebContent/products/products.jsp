...
<table id="notice" width="900px" style="text-align:left;">
   ...
   <tr>
     <td><img src="upfile/<%=pb.getFile()%>" width="800px"></td></tr>
   <tr> <td class="center"><h3> <center> <a href="content.jsp?bno=<%=pb.getBno()%>&pageNum=<%=pageNum%>"><%=pb.getSubject() %> </center><br><br><br><br><br><br></a></h3></td> </tr>   
